...
export function Sidebar({
  ...
  return (
    <aside
      className={cn(
        "fixed inset-y-0 left-0 z-50 flex w-60 flex-col border-r border-border bg-sidebar p-4 transition-[width,transform] duration-200 lg:sticky lg:inset-auto lg:top-0 lg:h-screen lg:translate-x-0 overflow-hidden",
