...
export function PengantarPrintToolbar({ title }: { title?: string }) {
  return (
    <div className="no-print sticky top-0 z-10 flex items-center justify-between gap-3 px-4 py-2.5 bg-panel border-b border-border">
      <p className="text-[12px] font-bold text-foreground">{title ?? "Surat Pengantar Pengambilan Uang — Print Preview"}</p>
